                    ...
                    <div className="row align-items-center justify-content-between">
                        ...
                        <div className="hero-content-left text-white text-center">
                            ...
                            <div className="d-flex justify-content-center flex-lg-row flex-column">
                                <Button variant="#7FB6D4" className="mt-4 embed-responsive-4by30 mx-5 mx-lg-0">Contactez-moi </Button>
                                <p className="mt-lg-5 mt-3 lead ml-lg-4"><u>OU </u></p>
                                <Button variant="#7FB6D4" className="mt-lg-4 embed-responsive-4by30 mx-5 mr-lg-0 mr-lg-4">Demandez un devis</Button>
                            </div>
